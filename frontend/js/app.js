...
function initSplash() {
    ...
    const particleMultiplier = isMobile ? 1.5 : 1;
    const particleCount = Math.floor(25 * particleMultiplier);
    const centerCount = Math.floor(15 * particleMultiplier);
    ...
    class Particle {
        ...
        reset(color, side) {
            ...
            this.size = (Math.random() * 120 + 60) * particleMultiplier;
            this.speedX = side === 'left' ? Math.random() * 1 + 0.5 : -(Math.random() * 1 + 0.5);
            this.speedY = (Math.random() * 0.5 - 0.25) * 0.5;
            this.opacity = 0;
            this.targetOpacity = Math.random() * 0.4 + 0.3;
            this.blur = (Math.random() * 40 + 20) * particleMultiplier;
            this.wobble = Math.random() * Math.PI * 2;
            this.wobbleSpeed = Math.random() * 0.01 + 0.005;
            this.wobbleAmount = (Math.random() * 30 + 10) * particleMultiplier;
        ...
        update() {
            ...
            this.x += this.speedX;
            this.y += this.speedY + Math.sin(this.wobble) * this.wobbleAmount * 0.05;
    ...
    for (let i = 0; i < centerCount; i++) {
        ...
        p.size = (Math.random() * 80 + 40) * particleMultiplier;
        particles.push(p);
    }
    ...
    function animate() {
        ...
        const glowSize = isMobile ? 200 : 300;
        const centerGlow = ctx.createRadialGradient(width / 2, height / 2, 0, width / 2, height / 2, glowSize);
